...
export default function Home() {
  return (
    <PageMain>
      ...
      Whether you are a truck owner who wants to display up to date information and hours about your truck,
      or if you are a passerby looking to see what options are available to you, Temple Food Trucks has it all!
      </p>
      <h1 className='mt-5 text-md'>Rate your favorite food trucks here! Link:</h1>
      <h1 className='mt-5'>Project Members: Nathan Cherny, Andrew Nieves, Adil Syed, Felix Hardjana, Avenue Goldberg</h1>
      <img

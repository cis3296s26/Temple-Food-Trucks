...
class FoodTruckSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FoodTruck
        fields = ['id', 'name', 'description', 'foodType', 'phoneNumber', 'dietaryRestrictions', 'popularity', 'location', 'priceRange', 'status', 'openingTime', 'closingTime', 'owner', 'image', 'gallery_images']
